"""cc_cortex.sentinel — Behavioral pattern detection for loops.

@module sentinel
@responsibility Detect stuck/brute-force/hijack patterns in tool calls
@dependencies cc_cortex.constants, cc_cortex.core.log,
    cc_cortex.core.path_utils, cc_cortex.core.state_store,
...
from cc_cortex.constants import READ_TOOLS, WRITE_TOOLS, make_deny
from cc_cortex.core.log import get_logger
from cc_cortex.core.path_utils import extract_file_path, normalize_path
...
def _has_lint_errors(file_path: str) -> bool:
    ...
    try:
        ...
        ux_path = os.path.join(proj, ".cc_cortex_cache", "streak_ux.json")
        if os.path.isfile(ux_path):
            from cc_cortex.core.atomic import read_json
