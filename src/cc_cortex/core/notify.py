"""cc_cortex.core.notify — Cross-platform notification system.
...
def _win_toast_xmldoc(
    ...
    try:
        ...
        vbs_path = os.path.join(tempfile.gettempdir(), "cc_cortex_toast.vbs")
...
def show_toast(
    ...
    Args:
        ...
        app_id: Windows AppUserModelId for the toast.
