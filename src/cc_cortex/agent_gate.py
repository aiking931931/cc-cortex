"""cc_cortex.agent_gate — Agent spawn gate with counting, escalation, and hard deny.
...
from cc_cortex.constants import make_allow, make_deny
...
def _research_keywords() -> list[str]:
    from cc_cortex.i18n import patterns
