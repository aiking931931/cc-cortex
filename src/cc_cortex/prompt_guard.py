"""cc_cortex.prompt_guard — Clarity gate + multi-question detection for UserPromptSubmit.
...
Usage:
    from cc_cortex.prompt_guard import run_clarity_gate, multi_question_injection
