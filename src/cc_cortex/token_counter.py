"""cc_cortex.token_counter — Hybrid token counter (fast/accurate/hybrid).
...
def _estimate_fast(text: str) -> int:
    """CJK-aware local estimator. Identical math to field_read._estimate_tokens."""
    if not text:
        return 0
