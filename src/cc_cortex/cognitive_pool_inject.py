"""cc_cortex.cognitive_pool_inject — Pool-to-context injection layer.

@module cognitive_pool_inject
@responsibility Convert :class:`~cc_cortex.cache.cognitive_pool.CognitivePool`
...
@dependencies cc_cortex.cache.cognitive_pool (lazy import, fail-safe)
...
if TYPE_CHECKING:
    from cc_cortex.cache.cognitive_pool import PoolSection
...
def build_pool_context(
    *,
    ...
    rag/delivery sections in :func:`cc_cortex.cognitive_inject.build_cognitive_context`.
