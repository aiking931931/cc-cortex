"""cc-cortex PostCompact hook — re-inject critical state after compaction.
...
def _get_wiredo_status(cache_dir: str, session_id: str) -> str:
    ...
    try:
        from cc_cortex.delivery.wiredo import wiredo_full_check
...
def _read_and_clean_snapshot(cache_dir: str) -> dict:
    ...
    """
    from cc_cortex.hooks.on_pre_compact import SNAPSHOT_FILENAME
