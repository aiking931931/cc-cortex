"""cc-cortex PostToolUseFailure hook — failure pattern analysis.
...
scoped JSONL at ``.cc_cortex_cache/tool_failures.jsonl`` to a session-
...
def _dispatch(hook_data: dict) -> None:
    ...
    try:
        from cc_cortex.confidence_record import update_confidence
        update_confidence(
            cache_dir,
            domain=tool,
            success=False,
