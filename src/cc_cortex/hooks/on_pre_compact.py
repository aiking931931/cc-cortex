"""cc-cortex PreCompact hook — write snapshot before CC compaction.
...
def main(hook_data: dict | None = None) -> None:
    ...
    Writes snapshot to .cc_cortex_cache/compact_snapshot.json.
    ...
    try:
        from cc_cortex.token_zone import increment_compact_count
