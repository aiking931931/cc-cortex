"""cc_cortex.star — Stimulus-Triggered Agentic Retrieval (STAR) Engine.
...
@responsibility Unified cognitive RAG engine for AI agents.
    ...
    Integrates with Riverbed Memory (cc_cortex.riverbed) for depth-based recall.
    Precision-first: 3 high-quality results > 5 mixed (Liu 2023, Cuconasu 2024).
@dependencies cc_cortex.rag (optional vector backbone), cc_cortex.riverbed (optional depth),
    cc_cortex.knowledge (optional corrections/learnings)
...
Relationship to RMT (cc_cortex.riverbed):
...
Usage::
    ...
    from cc_cortex.star import STAREngine, RetrievalTier
...
class STAREngine:
    ...
    def __init__(
        ...
        cache_dir = cache_dir or os.path.join(self.project_dir, ".cc_cortex_cache")
...
def create_star_engine(
    ...
    cache_dir = cache_dir or os.path.join(project_dir, ".cc_cortex_cache")
