"""cc_cortex.tools.builtin.file_io — FileRead / FileWrite / FileEdit tools.
...
@dependencies cc_cortex.core.state_store (hard), cc_cortex.tool_executor (Tool
...
logger = logging.getLogger("cc_cortex.tools.builtin.file_io")
...
def _default_cache_dir() -> str:
    ...
    by :class:`cc_cortex.tool_executor.ToolExecutor`.
    """
    return os.environ.get("CC_CORTEX_CACHE_DIR", ".cc_cortex_cache")
