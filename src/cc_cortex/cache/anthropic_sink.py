"""cc_cortex.cache.anthropic_sink — Concrete CacheEditSink implementation.
...
@dependencies cc_cortex.cache.microcompact (CacheEdit, CacheEditSink, SectionEdit)
...
logger = logging.getLogger("cc_cortex.cache.anthropic_sink")
