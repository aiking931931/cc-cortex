"""cc_cortex.cache.append_only_log — Lossless cognitive event log.
...
- **No personal paths**: default directory is ``Path.home() /
  .cc_cortex_cache / append_only_log``, overridable via the
...
_DEFAULT_SUBPATH = (".cc_cortex_cache", "append_only_log")
...
class AppendOnlyLog:
    ...
    Args:
        log_dir: Override the storage root. Resolution order is
            ...
            ``Path.home() / .cc_cortex_cache / append_only_log``.
    """
