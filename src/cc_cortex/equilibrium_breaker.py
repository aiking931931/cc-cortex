"""cc_cortex.equilibrium_breaker — Dynamic equilibrium circuit breaker.
...
@dependencies cc_cortex.core.state_store, cc_cortex.guards.base
...
from cc_cortex.guards.base import GuardCategory
from cc_cortex.ziq_control.equilibrium_adapter import should_freeze_pressure
