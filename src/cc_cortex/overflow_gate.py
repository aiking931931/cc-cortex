"""cc_cortex.overflow_gate — Block side-quests when attention is exhausted.
...
@dependencies cc_cortex.guards.base, cc_cortex.token_zone, cc_cortex.core.state_store
...
from cc_cortex.token_zone import Zone, read_zone_file
