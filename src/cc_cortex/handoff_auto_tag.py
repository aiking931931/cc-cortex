...
from cc_cortex.handoff_index import HANDOFF_DIR  # noqa: F401

# 內容關鍵字 → tag 映射（通用版，可透過 CC_CORTEX_KEYWORD_TAGS 環境變數覆寫）
KEYWORD_TAGS = {
...
def main() -> None:
    """CLI entry point for cc-handoff-tag.
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to CC_CORTEX_HANDOFF_DIR env var, "
    ...
    if not HANDOFF_DIR.exists():
        print(
            ...
            f"  Set CC_CORTEX_HANDOFF_DIR env var, use --dir, "
