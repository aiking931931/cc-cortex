"""cc_cortex.cognitive_anchor — Red-team anchoring for critical decisions.
...
@dependencies cc_cortex.constants, cc_cortex.guards.base, cc_cortex.core.state_store,
    cc_cortex.hypothesis_tracker
...
class CognitiveAnchorGuard(BaseGuard):
    ...
    def check(self, ctx: GuardContext) -> Optional[GuardResult]:
        ...
        try:
            from cc_cortex.hypothesis_tracker import get_failed_context
