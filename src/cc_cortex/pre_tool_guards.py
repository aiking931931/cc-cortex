...
@dependencies cc_cortex.constants, cc_cortex.core.log, cc_cortex.core.path_utils,
             cc_cortex.core.state_store, cc_cortex.guards.base
...
from cc_cortex.core.path_utils import normalize_path
