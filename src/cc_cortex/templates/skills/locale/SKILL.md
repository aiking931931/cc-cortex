...
2. Edit the generated file at `cc_cortex/locale/<lang>.json`
...
```python
from cc_cortex.i18n import get_locale, get_active_locales, locale_dir
...
```python
from cc_cortex.i18n import set_locale
set_locale("<lang>")
```
...
1. Copy the English locale as template:
   ```python
   from cc_cortex.i18n import locale_dir
