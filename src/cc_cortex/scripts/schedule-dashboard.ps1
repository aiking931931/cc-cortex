...
# Part of cc-cortex: The Cognitive Layer for Claude Code
...
<Window
    ...
    <Grid Margin='16'>
        ...
        <Grid Grid.Row='3' Margin='0,10,0,0'>
            ...
            <TextBlock Grid.Column='0' Text='cc-cortex | The Cognitive Layer for Claude Code' Foreground='#555' FontSize='10' VerticalAlignment='Center'/>
