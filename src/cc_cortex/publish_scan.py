"""cc_cortex.publish_scan — Pre-publish artifact scanner.
...
Usage:
    from cc_cortex.publish_scan import scan_dist
...
CLI:
    cc-cortex publish-scan [dist_dir]
"""
...
class SemverGuard(BaseGuard):
    ...
    _snapshot_path = ".cc_cortex_cache/api_snapshot.json"
