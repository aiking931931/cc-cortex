"""cc_cortex.agent.iterative_retrieve — Letta-inspired three-layer cascade retrieval.
...
@dependencies cc_cortex.cache.cognitive_pool, cc_cortex.cache.l2_distill
...
def _tokenize(text: str) -> set[str]:
    ...
    to the contract in :mod:`cc_cortex.cache.l2_distill` so L3 keyword
...
class IterativeRetriever:
    ...
    Args:
        pool: The L3 :class:`~cc_cortex.cache.cognitive_pool.CognitivePool`.
        distiller: The L2 :class:`~cc_cortex.cache.l2_distill.L2Distiller`.
