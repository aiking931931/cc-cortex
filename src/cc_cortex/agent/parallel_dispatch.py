"""cc_cortex.agent.parallel_dispatch — Subagent dispatch router.
...
@dependencies stdlib only + :mod:`cc_cortex.agent.fork_context`
...
Design notes:
  ...
  - Fork guards: :func:`is_in_fork_child` from
    :mod:`cc_cortex.agent.fork_context` checks depth > 0. Fork
