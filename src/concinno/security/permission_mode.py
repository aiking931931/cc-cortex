"""concinno.security.permission_mode — Session-scoped permission mode FSM.
...
@responsibility Provide a session-scoped 5-mode state machine that gates
    ...
    concinno per-event regex guards (stateless, fire-and-forget), this
...
Design notes:
  ...
  - Rules use `fnmatch.fnmatchcase` rather than full regex. This
    ...
    small — 55 regex guards already exist in concinno for cases that
