...
must explicitly mark it, not skip it.
  ...
  vscode_extension (.vsix) → REQUIRED: W I D E O    | N/A: R
    D recipe: windows Skill headless verify (Tier 1 static unzip +
    Tier 2 PrintWindow screenshot); tsc/lint clean does NOT count.
