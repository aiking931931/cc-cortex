"""concinno.session_format — Session ID format enforcement + task-pool ABCD validation.
...
Usage:
    from concinno.session_format import check_session_id, check_taskpool_required
