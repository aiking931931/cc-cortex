"""concinno.ziq_retrieval — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.retrieval` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_retrieval import X

    # NEW
    from concinno.ziq.retrieval import X
"""
...
from concinno.ziq import retrieval as _canon

_warnings.warn(
    "concinno.ziq_retrieval is deprecated; import from concinno.ziq.retrieval "
