"""concinno.ziq_persist — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.persist` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_persist import X

    # NEW
    from concinno.ziq.persist import X
"""
...
from concinno.ziq import persist as _canon

_warnings.warn(
    "concinno.ziq_persist is deprecated; import from concinno.ziq.persist "
