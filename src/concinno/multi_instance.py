"""concinno.multi_instance — Multi-session coordination and conflict detection.
...
@dependencies concinno.constants, concinno.core.path_utils
...
from concinno.constants import WRITE_TOOLS
from concinno.core.path_utils import extract_file_path as _extract_fp
