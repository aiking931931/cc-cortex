"""concinno.ziq_autotune_loop — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.autotune_loop` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_autotune_loop import X

    # NEW
    from concinno.ziq.autotune_loop import X
"""
...
from concinno.ziq import autotune_loop as _canon

_warnings.warn(
    "concinno.ziq_autotune_loop is deprecated; import from concinno.ziq.autotune_loop "
