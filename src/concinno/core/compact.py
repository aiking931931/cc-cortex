"""concinno.core.compact — PreCompact state preservation.
...
def save_compact_state(
    ...
    Args:
        ...
        output_path: Where to save (default: CLAUDE_PROJECT_DIR/.concinno_cache/compact_state.json)
    ...
    if not output_path:
        ...
        output_path = os.path.join(base, ".concinno_cache", "compact_state.json")
