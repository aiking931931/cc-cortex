#!/usr/bin/env python3
"""concinno Script Skill Check — remind to consult kb_* Skills when writing scripts.
...
from concinno.core.path_utils import extract_file_path as _extract_file_path
