"""concinno.ziq_outcome_bus — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.outcome_bus` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_outcome_bus import X

    # NEW
    from concinno.ziq.outcome_bus import X
"""
...
from concinno.ziq import outcome_bus as _canon

_warnings.warn(
    "concinno.ziq_outcome_bus is deprecated; import from concinno.ziq.outcome_bus "
