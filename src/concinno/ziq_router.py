"""concinno.ziq_router — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.router` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_router import X

    # NEW
    from concinno.ziq.router import X
"""
...
from concinno.ziq import router as _canon

_warnings.warn(
    "concinno.ziq_router is deprecated; import from concinno.ziq.router "
