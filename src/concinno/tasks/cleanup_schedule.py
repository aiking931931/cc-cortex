"""concinno.tasks.cleanup_schedule — Daily cleanup task.
...
@dependencies concinno.cleanup (run_cleanup)
...
def run_cleanup_task(
    ...
    Calls the existing ``concinno.cleanup.run_cleanup`` with sensible
