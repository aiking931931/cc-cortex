"""concinno.tools.builtin.search — Glob and Grep tools (Aegis P0.3).
...
Both tools satisfy ``concinno.tool_executor.Tool`` (``name``, ``description``,
...
#: GlobTool/GrepTool exclusions plus a few concinno-specific cache dirs.
