"""concinno.ziq_emit_helpers — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.emit_helpers` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_emit_helpers import X

    # NEW
    from concinno.ziq.emit_helpers import X
"""
...
from concinno.ziq import emit_helpers as _canon

_warnings.warn(
    "concinno.ziq_emit_helpers is deprecated; import from concinno.ziq.emit_helpers "
