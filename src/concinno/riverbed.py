"""concinno.riverbed — Riverbed Memory Topology (RMT) Engine.
...
@dependencies concinno.rag (optional, for vector projection backbone)
...
class RiverbedMemory:
    ...
    def __init__(
        ...
        self.cache_dir = cache_dir or os.path.join(
            self.project_dir, ".concinno_cache", "riverbed"
        )
