...
Wraps the battle-tested logic from ``concinno.multi_instance`` behind the
...
from concinno.core.notify import make_session_title
from concinno.core.session import save_session_marker
