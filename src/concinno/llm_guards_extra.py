"""concinno.llm_guards_extra — Additional LLM-backed semantic guards.

Requires ``pip install concinno[llm]``. Each guard extends LLMGuard
with a specific judge prompt. Fail-open if no LLM SDK installed.
"""

from __future__ import annotations

from concinno.llm_guard import LLMGuard
