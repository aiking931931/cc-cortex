...
class CognitiveEngine:
    ...
    def check_sentinel(
        ...
        try:
            from concinno.sentinel import check_sentinel  # type: ignore[attr-defined]
        except ImportError:
            return None
    ...
    def check_tidy(self, tool_name: str, tool_input: dict) -> Optional[str]:
        ...
        try:
            from concinno.evolution import check_tidy_balance
        except ImportError:
            return None
    ...
    def on_session_end(self, transcript_path: str = "") -> None:
        ...
        if transcript_path:
            try:
                from concinno.knowledge import extract_corrections
    ...
    def get_summary(self) -> str:
        ...
        lines: list[str] = []
        lines.append("🧠 concinno Cognitive Layer")
        lines.append("")
