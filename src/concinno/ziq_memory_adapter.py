"""concinno.ziq_memory_adapter — DEPRECATED legacy alias.

Forwards every attribute access (including private ``_x`` names) to
:mod:`concinno.ziq.memory_adapter` (the canonical module under the
...
Migration::
    ...
    # OLD
    from concinno.ziq_memory_adapter import X

    # NEW
    from concinno.ziq.memory_adapter import X
"""
...
from concinno.ziq import memory_adapter as _canon

_warnings.warn(
    "concinno.ziq_memory_adapter is deprecated; import from concinno.ziq.memory_adapter "
