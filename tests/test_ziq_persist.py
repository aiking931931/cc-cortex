...
# SkillDisclosure integration tests removed: K5 cull deleted
# concinno.skills.disclosure (Lyceum routing covers the surface).
# The "skill_disclosure" string at line 102 above remains as a stable
# feature-key label for round-trip testing of ziq_persist itself —
# the persistence layer is feature-name-agnostic.
